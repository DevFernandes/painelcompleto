...
$result_usuario = "SELECT * FROM prod ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
...
if(($resultado_usuario) AND ($resultado_usuario->num_rows != 0)){
		...
		<tbody>
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
				...
				<tr>
					...
					<td><?php echo $row_usuario['produto']; ?></td>
	...
	$result_pg = "SELECT COUNT(id) AS num_result FROM prod";
